...
function ContentComponent(){
    ...
    useEffect(() => {
        ...
        //var productsFiltered = filterProducts(fillterName, PriceMin, PriceMax, valueSelectTypeProduct); // gọi hàm filterProducts bên component filterProducts
            ...
            <Row>
                <Col sm="12">
                    <Row>
                        ...
                        <Col sm="9">
                            <ProductsListComponent productNew={productNew}/>
                        </Col>
                    </Row>
                </Col>
